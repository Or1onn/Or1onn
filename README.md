Написать программу планировщик задач. 
Есть Listbox и Поле ввода задачи.
Кнопка сделано и удалить задачу, добавить задачу.

При вводе задачи, онап вводится в Listbox. 
Если выбрать задачу и нажать на кнопку сделано, меняется цвет задачи на зеленый.
По умолчани все задачи красного цвета. 
